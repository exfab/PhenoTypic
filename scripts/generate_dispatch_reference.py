...
Walks ``phenotypic._gui.builder._callbacks._dispatch_state_update``,
...
:data:`phenotypic._gui.builder._callbacks.DispatchKind` to enumerate the
...
# ``phenotypic._gui.builder._callbacks.DispatchKind`` to:
...
.. note::
   ...
   from
   :data:`phenotypic._gui.builder._callbacks.DispatchKind` plus a
...
:func:`phenotypic._gui.builder._callbacks._dispatch_state_update`.
...
3. **Post-mutation:** the fan-in callback re-runs
   :func:`phenotypic._gui.builder._validation.validate`; the resulting
...
def _enumerate_dispatch_kinds() -> List[str]:
    ...
    from phenotypic._gui.builder._callbacks import DispatchKind  # noqa: PLC0415
