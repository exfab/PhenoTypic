...
Reads the :data:`phenotypic._gui.builder._validation.IssueKind` literal
...
.. note::
   ...
   :data:`phenotypic._gui.builder._validation.IssueKind` plus a
...
:func:`phenotypic._gui.builder._validation.validate` that walks every
scope reachable from ``state.root`` and emits a flat list of
:class:`~phenotypic._gui.builder._validation.Issue` records. Blocking
...
def _enumerate_issue_kinds() -> List[str]:
    ...
    from phenotypic._gui.builder._validation import IssueKind  # noqa: PLC0415
