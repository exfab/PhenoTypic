...
|---|---|---|---|
| D01 | Reject Boolean/complex, non-array, empty, or non-2-D input with explicit Python exceptions. | The source relies on assertions/conversions and has no stable public error contract. Real numeric arrays, including nonfinite values, retain source behavior. | Invalid-input tests and wrapper-free API review |
