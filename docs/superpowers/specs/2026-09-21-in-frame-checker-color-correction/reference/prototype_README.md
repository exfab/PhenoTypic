...
**[0.786, 1.222, 1.315], divergence 0.238** — inside the range the plate
frames give (0.227–0.243, ratios 0.71–0.78 / 1.11–1.18 / 1.30–1.33). The
effect is identical with and without a plate in the picture, so it is a
property of the chart grouping and of fitting a root-polynomial across a
split gamut, not of the optics (`chart_group_gain_control.csv`).
