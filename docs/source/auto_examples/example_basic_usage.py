...
This example demonstrates basic usage of PhenoTypic for _parent_image processing.
"""
...
# %%
# Create a simple test _parent_image
...
# %%
# Extract features from the _parent_image
