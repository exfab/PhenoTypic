...
@pytest.mark.parametrize(
    ...
    [
        ...
        (EnhanceFeatures(), "n_scale", IntRange, (3, 6)),
        (EnhanceFeatures(), "min_wavelength", FloatRange, (2.0, 10.0, False)),
        (EnhanceFeatures(), "sigma_onf", FloatRange, (0.1, 1.0, False)),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        lambda: EnhanceFeatures(n_scale=0),
        lambda: EnhanceFeatures(n_orient=0),
        lambda: EnhanceFeatures(min_wavelength=1.0),
        lambda: EnhanceFeatures(mult=1.0),
        lambda: EnhanceFeatures(k=-1.0),
        lambda: EnhanceFeatures(g=0.0),
        lambda: EnhanceFeatures(sigma_onf=0.05),
        lambda: EnhanceFeatures(sigma_onf=1.5),
        lambda: EnhanceFeatures(cutoff=0.0),
        lambda: EnhanceFeatures(cutoff=1.0),
        lambda: FlattenIllumination(sigma=0.0),
        lambda: BM3DDenoiser(sigma_psd=-0.1),
    ],
)
