...
class TestSelectCellObject:
    ...
    def test_dominant_picks_largest(self):
        ...
        # Large object in corner (many pixels)
        region[0:8, 0:8] = 1
        # Small object near center (few pixels)
        region[9:11, 9:11] = 2
    ...
    def test_centered_picks_closest_to_center(self):
        ...
        region = np.zeros((20, 20), dtype=np.int32)
        # Large object in corner
        region[0:8, 0:8] = 1
        # Small object near center
        region[9:11, 9:11] = 2
    ...
    def test_centered_vs_dominant_differ(self):
        ...
        region = np.zeros((20, 20), dtype=np.int32)
        region[0:8, 0:8] = 1  # Large corner
        region[9:11, 9:11] = 2  # Small center
...
class TestGridAlignmentRefinerSelectionMode:
    """Test GridAlignmentRefiner with different selection modes."""
    ...
    def test_centered_mode_produces_results(self):
        ...
        refiner = GridAlignmentRefiner(selection_mode="centered")
        refined = refiner.apply(detected)
    ...
    def test_regularized_mode_produces_results(self):
        ...
        refiner = GridAlignmentRefiner(selection_mode="regularized")
        refined = refiner.apply(detected)
    ...
    def test_json_roundtrip_with_selection_mode(self):
        ...
        pipeline = ImagePipeline([
            RoundPeaksDetector(),
            GridAlignmentRefiner(selection_mode="centered"),
        ])
        ...
        refiner = ops["GridAlignmentRefiner"]
        assert isinstance(refiner, GridAlignmentRefiner)
