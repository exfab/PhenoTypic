...
def test_badge_renders_for_pickable_ops():
    """ManualPointDetector and ManualSelector get a PICK badge; OtsuDetector does not."""
    ...
    assert "ManualSelector" in pickable_button_classnames
    ...
    assert "ManualSelector" in badge_owners
