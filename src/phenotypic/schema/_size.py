...
class SIZE(DirectPhenotype):
    ...
    MEDIAN_RADIUS = Entry(
        ...
        "outer outline of every piece of the colony is sampled and holes are "
        "ignored, so a colony made of several pieces (a runner joined only at a "
        "corner, or fragments merged into one colony) is measured whole, and "
        "MaxRadius reaches its farthest piece. The "
