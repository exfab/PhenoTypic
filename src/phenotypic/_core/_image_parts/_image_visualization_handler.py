...
class ImageVisualizationHandler(ImageObjectsHandler):
    """Provide image-level visualization methods outside the accessor API."""
    ...
    def napari(
        ...
        """
        from .accessor_abstracts._image_accessor_base import _HAS_NAPARI
