...
class MeasurementAccessor:
    ...
    def values(self) -> List[Union[pd.Series, pd.DataFrame]]:
        ...
        Examples:
            Get independent copies of all measurements:
    ...
    def __setitem__(self, key: str, value: Union[pd.Series, pd.DataFrame]) -> None:
        ...
        Examples:
            Store Series and DataFrame measurements:
    ...
    def pop(
        ...
        Examples:
            Remove and return measurements with error handling:
    ...
    def clear(self) -> None:
        ...
        Examples:
            Clear all measurements from the accessor:
    ...
    def merge_on_index_names(
        ...
        Examples:
            Merge measurements by index name:
    ...
    def to_dict(self) -> Dict[str, Union[pd.Series, pd.DataFrame]]:
        ...
        Examples:
            Export measurements as a dictionary with copies:
    ...
    def to_recarrays_dict(self) -> Dict[str, np.recarray]:
        ...
        Examples:
            Convert measurements to numpy structured arrays:
    ...
    def copy(self) -> "MeasurementAccessor":
        ...
        Examples:
            Create a copy with shared measurement references:
