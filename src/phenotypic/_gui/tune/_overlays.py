...
:mod:`phenotypic._gui.tune` itself — must never drag ``optuna`` into
...
:func:`~phenotypic._gui.builder._image_renderer.to_overlay_rgb_array`. Neither
...
from phenotypic._gui._design import OI_GREY, OI_ORANGE, OI_SKY, hex_to_rgb
from phenotypic._gui.builder._image_renderer import _downscale, to_overlay_rgb_array
...
def render_difference(
    ...
    *,
    ...
    :mod:`phenotypic._gui._design` (never hard-coded hex).
