...
sibling :mod:`phenotypic._gui._design` module because they have a CSS
...
#: :func:`phenotypic._gui.shell._app._build_shell_dash_app`.
...
#: :class:`phenotypic._gui.OperationRegistry` handle (catalog of
...
#: :class:`phenotypic._gui.shell._runs_registry.RunRegistry` handle
...
#: ``app.server.config`` key holding the analysis sub-app's
#: :class:`~phenotypic._gui._schema_cache.MeasurementSchema` —
...
# here so existing GUI imports (``from phenotypic._gui._config import MEASUREMENTS_CSV``)
...
#: :func:`phenotypic._gui._shared.tiles.register_crop_route`). Both routes
