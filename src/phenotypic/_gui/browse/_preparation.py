...
from phenotypic._gui.browse._cache import BrowseCache, CacheEntry
from phenotypic._gui.browse._source_probe import SourceRevision, probe_source
from phenotypic._gui.browse._source_render import normalize_to_png
...
def _default_tile(png_path: Path, output_dir: Path, **kwargs: int) -> Path:
    from phenotypic._gui.results_viewer._dzi_tiler import tile
