...
its facade -- see :mod:`phenotypic._gui._shared._viv_assets`, which serves the
results viewer's two files to any other sub-app that renders through
``window.phenotypicViv``.
"""
from phenotypic._gui._shared._blueprint import (
    SHARED_BLUEPRINT_PREFIX,
    SHARED_LOGO_PATH,
    register_shared_static,
)
from phenotypic._gui._shared._viv_assets import (
    VIV_ASSETS_PREFIX,
    VIV_BUNDLE_PATH,
    VIV_FACADE_PATH,
    register_viv_assets,
