...
Category colors come from :func:`phenotypic._gui._design.category_color` (core
...
def build_radial_trigger(
    ...
    :func:`~phenotypic._gui._shared.tiles.build_tile_cell`.
    ...
    category badge** (via :func:`~phenotypic._gui._design.category_color`).
    ...
    Examples:
        >>> from phenotypic._gui._shared._radial import build_radial_trigger
...
def build_radial_body(
    ...
    * A center restore/close node (``category = RADIAL_RESTORE_SENTINEL``).
    ...
    Examples:
        >>> from phenotypic._gui._shared._radial import build_radial_body
...
def _build_custom_section(
    ...
    * one chip per registered custom category token, colored by
      :func:`~phenotypic._gui._design.category_color` (cycling the custom
