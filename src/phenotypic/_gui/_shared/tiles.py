...
* the **colony-view** tab — a 2D axis-header grid (see
  :mod:`phenotypic._gui.results_viewer.colony_view._grid`), and
...
from phenotypic._gui._shared._measurement_tint import TileMeasurement
    ...
    *,
    ...
    Args:
        ...
        bg: RGB colour the dimmed pixels blend toward. Defaults to
            :data:`phenotypic._gui._design.TILE_DIM_RGB` (black).
    ...
    *,
    ...
    Args:
        ...
        dim_alpha: Tile-spotlight strength. When ``> 0`` (and ``bbox`` is
            ...
            blended toward :data:`phenotypic._gui._design.TILE_DIM_RGB` by
...
def composite_contours(
    ...
    from phenotypic._gui._design import OI_ORANGE, OI_SKY, hex_to_rgb
...
def register_crop_route(
    ...
    * ``GET /<segment>/<dataset>/<stem>/<label>.png?size=<int>`` — returns
    ...
    #    module attribute makes ``phenotypic._gui._shared.tiles.request``
    ...
    from phenotypic._gui._config import TILE_DIM_MAX, TILE_DIM_MIN
    ...
    * the caller-supplied ``remove_button`` (each tab owns its own
    ...
    Args:
        ...
        measurement: The colony's value for the currently-displayed
            ...
            :meth:`~phenotypic._gui._shared._measurement_tint.MeasurementScale.measurement_for`.
...
def build_tile_grid(
    ...
    *,
    ...
    Unlike :func:`phenotypic._gui.results_viewer.colony_view._grid.build_grid`
...
def expand_range(
    ...
    Args:
        grid_order: Row-major flat list of cell keys, as returned by
            ...
            :func:`phenotypic._gui.results_viewer.colony_view._grid.build_grid`.
