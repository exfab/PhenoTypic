...
Use ``python -m phenotypic._gui.analysis --root <output-dir>`` to launch
the sub-app outside the unified hub. Mirrors the launcher convention
used by ``phenotypic._gui.results_viewer.__main__``.
"""
...
from phenotypic._gui.analysis import create_app
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        prog="python -m phenotypic._gui.analysis",
        description=(
