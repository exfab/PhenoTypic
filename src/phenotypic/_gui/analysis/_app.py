...
:mod:`phenotypic._gui.results_viewer._app`: builds a configured
:class:`dash.Dash` instance with the validated
:class:`~phenotypic._gui.results_viewer._output_root.OutputRoot` plus the
loaded :class:`~phenotypic._gui.analysis._recipe_state.RecipeState`
...
from phenotypic._gui.analysis._callbacks import register_callbacks
...
def _handoff_banner_state(selection):
    ...
    :func:`phenotypic._gui.results_viewer._app._handoff_banner_state`. The
