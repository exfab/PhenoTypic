...
from phenotypic._gui.results_viewer._filtered_state import KEY_IMAGE_FILE
...
def register_callbacks(app: "dash.Dash") -> None:
    ...
    - :data:`CFG_OUTPUT_ROOT` — the validated
      :class:`~phenotypic._gui.results_viewer._output_root.OutputRoot`.
    ...
    def _model_outputs(
        ...
        from phenotypic._gui.analysis._layout import _build_model_section
...
def _apply_param_edit(
    ...
    from phenotypic._gui._param_forms import parse_widget_value
...
def _run_inline(recipe: Any, output_root: "OutputRoot") -> Any:
    ...
    try:
        ...
        from phenotypic._gui._plot_refresh import refresh_analysis_plots
