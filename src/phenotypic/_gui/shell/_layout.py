...
from phenotypic._gui.shell._callbacks import register_chrome_callbacks
...
from phenotypic._gui.shell._sidebar import build_sidebar
from phenotypic._gui.shell._source_picker import (
