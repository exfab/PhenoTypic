...
def install_smart_grid(viewer: napari.Viewer) -> None:
    ...
    def _rebuild_vis_map():
        ...
        if v is None:
            _vis_map = {}
            return
        from phenotypic._gui._smart_grid._overlay_visuals import is_overlay_layer
    ...
    def _ensure_scenegraph_wrapped():
        ...
        from phenotypic._gui._smart_grid._grid_labels import add_grid_labels
        from phenotypic._gui._smart_grid._overlay_visuals import (
            cleanup_clones,
        ...
        from phenotypic._gui._smart_grid._grid_popup import patch_grid_popup
