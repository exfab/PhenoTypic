...
no side effects; it depends only on :mod:`phenotypic._gui.builder._state`
...
Examples:
    ...
    >>> from phenotypic._gui.builder._state import BuilderScope, BuilderState
...
from phenotypic._gui._operation_registry import OperationInfo, get_registry
