...
:data:`phenotypic._gui.builder._ids.STORE_BUILDER_STATE` plus the few helper
...
from phenotypic._gui.builder._ids import LoadPickerPage
from phenotypic._gui.builder._preview_callbacks import (
    build_preview_payload,
    resolve_source_spec,
)
from phenotypic._gui.builder._directory_browser import (
    IMAGE_EXTS,
    PIPELINE_EXTS,
    SYNTHETIC_SENTINEL,
    directory_tree,
...
from phenotypic._gui.builder._linear_layout import (
    build_linear_map_section,
    build_linear_side_loader,
)
from phenotypic._gui.builder._modal_browser import (
    no_root_placeholder,
...
from phenotypic._gui.builder._conversion_dag import from_pipeline_dag, to_pipeline_dag
from phenotypic._gui.builder._validation import validate
from phenotypic._gui.builder._validation import Issue
from phenotypic._gui.shell._ids import SHELL_SOURCE_IMAGE_ROOT_STORE
...
def _find_dag_container_scope(
    ...
    :func:`phenotypic._gui.builder._state._find_container_scope_by_block_id`,
...
def _seed_input_image_dict(scope_dict: Dict[str, Any]) -> None:
    ...
    Dict-level mirror of
    :func:`phenotypic._gui.builder._state._seed_input_image` — used by
...
def _render_views(state: BuilderState) -> Tuple[Any, Any, Any]:
    ...
    if stale_scope:
        ...
        if hasattr(state, "selected_block_id"):
            from phenotypic._gui.builder._state import _DagBuilderState
