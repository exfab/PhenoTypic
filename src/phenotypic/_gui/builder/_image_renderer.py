...
from phenotypic._gui._config import ChannelName
from phenotypic._gui._design import FONT_FAMILY_MONO, FONT_SIZE_LABEL
from phenotypic._gui._operation_registry import get_registry
from phenotypic._gui.builder._state import stage_of
...
def to_overlay_rgb_array(
    ...
    *,
    ...
    (``phenotypic._gui.tune._overlays.render_candidate_overlay``). Both pass the
