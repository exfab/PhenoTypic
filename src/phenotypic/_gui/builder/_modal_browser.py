...
:func:`~phenotypic._gui.builder._directory_browser.directory_tree` and the id
constants defined in :mod:`~phenotypic._gui.builder._ids`. Callbacks
(open/close, page swaps, tree re-renders, save/load actions) are wired up in
:mod:`~phenotypic._gui.builder._callbacks`; nothing here registers callbacks or
...
from phenotypic._gui._config import PIPELINE_JSON
