...
from phenotypic._gui._shared import SHARED_LOGO_PATH
from phenotypic._gui.builder import _ids as ids
from phenotypic._gui.builder._ids import StageName
...
def _bucket_issues_recursively(
    ...
    Args:
        ...
        issues: Flat list of :class:`~phenotypic._gui.builder._validation.Issue`
            instances.
...
def build_canvas_elements_dag(
    ...
    * **Container compound parents.** Container blocks
    ...
    Args:
        ...
        issues: List of :class:`~phenotypic._gui.builder._validation.Issue`
...
def _hidden_inspector_widgets() -> List[Any]:
    ...
    The fan-in callback in :mod:`phenotypic._gui.builder._callbacks` declares
...
def _doc_section_widgets(docstring: Optional[str]) -> List[Any]:
    ...
    The toggle callback in :mod:`phenotypic._gui.builder._callbacks` keys on
...
def _build_wire_card(
    ...
    Returns:
        ...
        :func:`phenotypic._gui.builder._ids.inspector_disconnect_id`.
    """
