...
these singletons in :func:`phenotypic._gui.shell._app.compose_hub` and
forwards them.

Standalone debugging via ``python -m phenotypic._gui.run_console`` still
...
from phenotypic._gui.run_console._callbacks import register_callbacks
from phenotypic._gui.run_console._layout import build_run_console_layout
from phenotypic._gui.run_console._runner import LocalRunner
from phenotypic._gui.run_console._slurm import SlurmSubmitResult, submit_slurm
