...
from phenotypic._gui.results_viewer.colony_view import _layout as _colony_layout  # noqa: F401
...
# ---------------------------------------------------------------------------
# Style tokens -- aliases of phenotypic._gui._design constants kept for
...
def _build_stores(filtered_state: "CurationLabels") -> Component:
    ...
    Args:
        filtered_state: The on-disk curation state loaded by
            :func:`phenotypic._gui.results_viewer._app.create_app`. Used to
