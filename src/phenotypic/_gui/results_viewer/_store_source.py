...
:func:`~phenotypic._gui._shared.tiles._readable_block` raises
:class:`~phenotypic._gui._shared.tiles.StoreUnreadable` on a schema-version
...
def build_source_spec(store: Path, base_url: str) -> dict:
    ...
    Args:
        ...
        base_url: Browser-visible base URL of this store generation, as
            built by
            :func:`~phenotypic._gui.results_viewer._zarr_routes.zarr_store_url`.
