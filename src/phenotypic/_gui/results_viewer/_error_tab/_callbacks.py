...
from phenotypic._gui.results_viewer._curation_labels import OTHER_CATEGORY
from phenotypic._gui.results_viewer._error_tab import _ids as ids
...
from phenotypic._gui.results_viewer._error_tab._figure import (
