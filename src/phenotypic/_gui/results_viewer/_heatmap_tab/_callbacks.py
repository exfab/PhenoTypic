...
from phenotypic._gui.results_viewer._heatmap_tab import _ids as ids
from phenotypic._gui.results_viewer._heatmap_tab._figure import (
    AggregatorName,
    build_heatmap_figure,
)
from phenotypic._gui.results_viewer._metadata import normalize_viewer_frame
...
def _as_key_set(payload: list[Any]) -> set[tuple[str, int]]:
    ...
    Mirrors :func:`phenotypic._gui.results_viewer._filtered_state
