...
crop-route factory :func:`phenotypic._gui._shared.tiles.register_crop_route`
...
from phenotypic._gui._config import COLONY_CROPS_URL_SEGMENT
...
def register(app: dash.Dash, output_root: OutputRoot) -> None:
    ...
    Thin adapter over
    :func:`phenotypic._gui._shared.tiles.register_crop_route` pinned to the
