...
:mod:`phenotypic._gui.results_viewer._assets`.
...
from phenotypic._gui.results_viewer._ids import (
...
def _colony_crop_url(
    ...
    *,
    ...
    The shared :func:`phenotypic._gui._shared.tiles.build_tile_cell` calls
...
def _build_cell(
    *,
    ...
    :func:`phenotypic._gui._shared.tiles.build_tile_cell` and layers on the
...
__all__ = [
    ...
    "plan_visible_cells",
    # Re-exported from :mod:`phenotypic._gui._shared.tiles` so colony-view
