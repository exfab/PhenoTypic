...
Notes:
    ...
    - Constants and pattern type-strings use kebab-case to match Dash
      ...
      :mod:`phenotypic._gui.builder._ids`.
"""
...
#: :class:`phenotypic._gui.results_viewer._filter_state.FilterSpec`).
...
def card_source_store_id(idx: str) -> Dict[str, str]:
    ...
    Payload is :func:`~phenotypic._gui.results_viewer._store_source
...
#: finished writing :data:`phenotypic._gui._config.CFG_QC_AUGMENTED_FRAME`.
...
#: :data:`phenotypic._gui._config.TILE_DIM_STEP` (clamped at
#: :data:`TILE_DIM_MIN`).
...
#: it (via :func:`phenotypic._gui._config.step_dim_alpha`); both galleries'
