...
* :func:`register_review_callbacks` — registers every Review callback;
  called from
  :func:`phenotypic._gui.results_viewer._qc_tab._callbacks.register_qc_callbacks`.
"""
...
from phenotypic._gui.results_viewer._qc_tab.review._layout import build_review_view
