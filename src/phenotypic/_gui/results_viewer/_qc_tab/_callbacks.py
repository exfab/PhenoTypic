...
from phenotypic._gui._design import COLOR_MUTED, OI_VERMILION, OI_VERMILION_TEXT
from phenotypic.sdk_.viz.figures import apply_theme
from phenotypic._gui._operation_registry import OperationRegistry
from phenotypic._gui._param_forms import param_form, parse_widget_value
...
from phenotypic._gui.results_viewer._qc_tab._layout import (
    _banner_style,
