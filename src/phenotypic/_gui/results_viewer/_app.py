...
:class:`~phenotypic._gui.results_viewer._output_root.OutputRoot` plus the
curation-state
:class:`~phenotypic._gui.results_viewer._curation_labels.CurationLabels`
stashed on ``app.server.config``, the layout assembled by
:func:`~phenotypic._gui.results_viewer._layout.build_app_layout`, and
all callbacks registered via
:func:`~phenotypic._gui.results_viewer._callbacks.register_callbacks`.
...
from phenotypic._gui._shared import register_shared_static
from phenotypic._gui._shared.tiles import register_crop_route
from phenotypic._gui._snapshot_status import snapshot_refresh_status
...
from phenotypic._gui.results_viewer._callbacks import register_callbacks
...
from phenotypic._gui.results_viewer.colony_view import (
    _crop_routes as colony_crop_routes,
)
from phenotypic._gui.shell._ids import SHELL_SIDEBAR_SELECTION_STORE
from phenotypic._gui.shell._binding_ui import binding_error_text
from phenotypic._gui.shell._ids import SHELL_RESULTS_BINDING_JOB_STORE
    ...
    *,
    ...
    Args:
        output_root: Validated, read-only handle on a CLI output
            directory (see
            :meth:`phenotypic._gui.results_viewer._output_root.OutputRoot.discover`).
