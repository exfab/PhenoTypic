...
class BBOX(MeasurementInfo):
    ...
    WEIGHTED_CENTER_RR = "WeightedCenterRR", ("The intensity weighted center "
                                              "row coordinate of the bounding box.")
    WEIGHTED_CENTER_CC = "WeightedCenterCC", ("The intensity weighted center "
