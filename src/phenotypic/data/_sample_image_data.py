...
def load_plate_12hr():
    """Returns a plate _parent_image of a K. Marxianus colony 96 array plate at 12 hrs"""
    return imread(current_file_dir / 'StandardDay1.jpg')


def load_plate_72hr():
    """Return's an _parent_image of a k. marxianus colony 96 array plate at 72 hrs"""
...
def load_colony_72hr():
    """Returns a colony _parent_image array of K. Marxianus"""
    return imread(current_file_dir / 'StdDay6-Results/well_imgs/StdDay6_well005.png')

def load_smear_plate_12hr():
    """Returns a plate _parent_image array of K. Marxianus that contains noise such as smears"""
