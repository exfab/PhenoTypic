...
class ImageArray:
    """This class represents an accessor for handling image arrays with helper methods for accessing, modifying, visualizing, and analyzing the multichannel image data.
    ...
    def __setitem__(self, key, value):
        ...
        Raises:
            C_ImageArraySubhandler.IllegalElementAssignmentError: Raised when an illegal
