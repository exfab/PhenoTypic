...
class ImageObjects:
    """An abstract for accessing image objects and provides various utilities for interacting with labeled objects in an image.
    ...
    def label_table(self)->pd.Series:
        ...
        return pd.Series(
            ...
            name=C_ObjectInfo.OBJECT_LABELS
        )
