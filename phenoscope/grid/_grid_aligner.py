...
class GridAligner(GridTransformer):
    """Rotates the image based on the alignment of the objects in the image
    ...
    def _operate(self, image: GridImage):
        ...
        Args:
            image (GridImage): The input grid image object to be aligned.

        Returns:
            GridImage: The rotated grid image object after alignment.
        """
        if self.axis == 0:
